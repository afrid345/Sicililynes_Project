...
namespace mission2
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load_1(object sender, EventArgs e)
        {
            ...
            portArrivee.DataSource = PortDAO.GetPort();
            portDepart.DataSource = PortDAO.GetPort();
        ...
        private void ajouter_Click(object sender, EventArgs e)
        {
            ...
            string add_duree = dureeAdd.Text;
            Port add_depart = portDepart.SelectedItem as Port;
            Port add_arrivee = portArrivee.SelectedItem as Port;

            LiaisonDAO.ajoutLiaison(add_duree, add_depart.getID(), add_arrivee.getID(),secteur.getID()) ;
