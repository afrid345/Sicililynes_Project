    ...
    internal class LiaisonDAO
    {
        ...
        public static List<Liaison> GetLiaison(int idSecteur)
        {
            ...
            try
            {
                ...
                com = maConnexionSql.reqExec("Select * From liaison where secteur_id ="+ idSecteur);
        ...
        public static void ajoutLiaison(string duree,int port_depart,int port_arrivee, int idSecteur)
        {
            try
            {
                ...
                com = maConnexionSql.reqExec("insert into liaison(duree,port_depart_id,port_arrive_id,secteur_id) values('"+duree+ "',"+ port_depart + ","+ port_arrivee+"," + idSecteur+");");
